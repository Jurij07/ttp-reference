...
ProvidenceData.CONNATES = {
	...
	{ name="Epic",      chance=8.5,  statBonus=1.22, lifespanMult=1.05, pros="All stats +22% · Lifespan +5%",cons="—" },
	{ name="Legendary", chance=5.0,  statBonus=1.40, lifespanMult=1.10, pros="All stats +40% · Lifespan +10%",cons="—" },
